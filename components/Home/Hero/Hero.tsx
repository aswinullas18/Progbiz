  ...
  return (
    ...
    <div className="relative w-full h-screen flex items-center  bg-black justify-center text-center  z-1 px-4 overflow-visible mt-0 ">
      <div className="w-full sm:w-[90%] md:w-[80%] max-w-screen-xl mx-auto flex flex-col items-center space-y-4  -mt-35">
        ...
        <button className={`group mt-2 sm:mt-4 flex items-center gap-2 bg-[#FFBE0D] border  text-black font-medium text-[14px] sm:text-[16px] leading-[23.2px] px-5 sm:px-6 py-2 rounded-full hover:text-black transition ${montserrat.className}`}>
          Connect-us
